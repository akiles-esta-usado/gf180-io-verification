...
extract
ext2spice lvs
ext2spice -o "$(LVS_DIR)/$(TOP_GDS_CELL)_extracted.spice"

puts "Created netlist file $(LVS_DIR)/$(TOP_GDS_CELL)_extracted.spice"
quit -noprompt
endef
...
ext2spice cthresh 0
ext2spice -o "$(PEX_DIR)/$(TOP_GDS_CELL)_pex.spice"

puts "Created pex file $(PEX_DIR)/$(TOP_GDS_CELL)_pex.spice"
